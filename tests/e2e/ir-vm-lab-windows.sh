...
grep -q '"host_role":"domain-controller"' "$BASE_D/00_metadata/intake.json" || fail "host_role != domain-controller"
grep -q '"scenario":"6"' "$BASE_D/00_metadata/intake.json" || fail "scenario != 6"
